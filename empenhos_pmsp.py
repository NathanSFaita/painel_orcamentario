...
for pagina in range(1, requisicoes + 1):
    requisicao += 1
    print(f"Requisição {requisicao} de {requisicoes}", end="\r")
...
if not df_parcial.empty:
    # Converte colunas para os tipos corretos antes de processar e mesclar
    ...
    # Formata o número do processo SEI
    codproc = (
...
pasta_destino = os.path.join(baseaux_path, "empenhos_pmsp")
