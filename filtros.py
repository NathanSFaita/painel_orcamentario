                ...
                [
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            dcc.Dropdown(id=f"{prefixo}-despesa", multi=True, closeOnSelect=False, optionHeight=75, style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 1000})
                        ], md=2),
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            dcc.Dropdown(id=f"{prefixo}-elemento", multi=True, closeOnSelect=False, optionHeight=75, style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 905})
                        ], md=5),
                        dbc.Col([
                            criar_label_com_tooltip("Vinculação", prefixo),
                            dcc.Dropdown(id=f"{prefixo}-vinculacao", multi=True, closeOnSelect=False, optionHeight=75, style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 904})
                        ], md=2),
                        dbc.Col([
                            criar_label_com_tooltip("Fonte", prefixo),
                            dcc.Dropdown(id=f"{prefixo}-fonte", multi=True, closeOnSelect=False, optionHeight=75, style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 903})
                        ], md=5),
                    ], className="mb-2", justify="center"),
                ] + (
                        ...
                        dbc.Row([
                            dbc.Col([
                                ...
                                dcc.Dropdown(id=f"{prefixo}-filtro-empenho", multi=True, closeOnSelect=False, optionHeight=75,
                                             style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 805})], md=2),
                            dbc.Col([
                                ...
                                dcc.Dropdown(id=f"{prefixo}-filtro-processo", multi=True, closeOnSelect=False, optionHeight=75,
                                             style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 804})], md=2),
                            dbc.Col([
                                html.Label("Data do Empenho", className="fw-bold"),
                                dcc.DatePickerRange(
                                    id=f"{prefixo}-date-picker",
                                    display_format="DD/MM/YYYY",
                                    start_date_placeholder_text="Data Início",
                                    end_date_placeholder_text="Data Fim",
                                    style={"zIndex": 1006, "width": "100%", "position": "relative"}
                                )
                            ], md=3),
                            dbc.Col([
                                ...
                                dcc.Dropdown(id=f"{prefixo}-filtro-credor", multi=True, closeOnSelect=False, optionHeight=75,
                                             style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 802})], md=5),
                        ], className="mb-2", justify="center"),
                        dbc.Row([
                            dbc.Col([
                                ...
                                dcc.Dropdown(id=f"{prefixo}-filtro-objeto", multi=True, closeOnSelect=False, clearable=True, optionHeight=75,
                                             style={"maxHeight": "45px", "overflowY": "visible", "zIndex": 701})], md=4),
